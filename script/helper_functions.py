...
def build_polynomial(x, degree):
    ...
    Returns:
        ...
        (d is the number of features, including the initial feature x and the polynomial basis functions up to degree d)
    """
...
def predict_labels(w, data):
    """Generates class predictions
        ...
        Returns:
            y_pred: shape=(N, ). The predicted labels for each sample.
    """
